    ...
    <div className="container my-5">
      <div className="text-center py-5">
        <h1 className="display-4">
          ...
          Destination for Buying Smartphones
        </h1>
      </div>
      <div className="row">
            ...
            <div className="card h-100">
              ...
              <div className="card-body">
                ...
                <div className="d-flex justify-content-between">
                  <button className="btn btn-primary" onClick={() => handleView(product.id)}>{product.button}</button>
                  <button className="btn btn-outline-secondary"   onClick={() => dispatch(AddToCart(product))}>{product.button1}</button>
                </div>
              </div>
            </div>
          </div>
